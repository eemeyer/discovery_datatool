...
create function makeBlob( source varchar( 32672 ) )
returns blob
language java
parameter style java
no sql
external name 'com.t11e.discovery.datatool.SqlChangesetExtractorTest.makeBlob';

insert into string_column_test (col_fixed, col_string, col_clob, col_blob) values
  (NULL, NULL, NULL, NULL),
  ('', '', '', makeBlob('')),
  ('a', 'b', 'c', makeBlob('d')),
  (' a ', ' b ', ' c ', makeBlob(' d '));
